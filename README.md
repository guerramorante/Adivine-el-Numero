...
Nivel 4 experto: entre 0 y 1000000000000""")
    ...
    if level <=4:
        if level ==1:
            ...
            print("Has seleccinado el nivel avanzado, tienes que adivinar un numero entre 0 y 1000000 y solo tienes 70 intentos")
        elif level ==4:
            print("Has seleccionado el nivel experto, tienes que adivinar un numero entre 0 y 1000000000000 y solo tienes 190 intentos")
    else:
...
![Captura](https://user-images.githubusercontent.com/91721714/141647208-2358422e-dbbb-42f0-9ff3-35baa9eeecae.PNG)
